      ...
      <div className="max-content flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start gap-1">
          <p className="font-body text-sm text-text-secondary">
            © {currentYear} <span className="text-text-primary font-medium">Prashant Kumar</span>. Crafted with care.
          </p>
          <p className="font-body text-[11px] text-text-muted">
            National Road Safety Winner 2019 (Toyota) · IEEE GRSS Chair, NMIT
          </p>
        </div>
